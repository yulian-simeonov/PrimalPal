...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:CGRectMake(CGRectGetMinX(frame), CGRectGetMinY(frame), CGRectGetWidth(frame), CGRectGetHeight(frame))]))
	{
		...
		self.searchField.font = [UIFont fontWithName:@"GillSans" size:17.0];
		self.searchField.textColor = [UIColor colorWithRed:104/255.0 green:186/255.0 blue:106/255.0 alpha:1.0];
		...
		self.searchImageViewOff = [[UIImageView alloc] initWithFrame:CGRectMake(0, (CGRectGetHeight(self.bounds) - kINSSearchBarImageSize) / 2, kINSSearchBarImageSize, kINSSearchBarImageSize)];
		...
		UIView *tapableView = [[UIView alloc] initWithFrame:CGRectMake(0.0, 0.0, CGRectGetWidth(self.bounds), CGRectGetHeight(self.bounds))];
...
- (void)showSearchBar:(id)sender
{
	if (self.state == INSSearchBarStateNormal)
	{
		...
		[UIView animateWithDuration:kINSSearchBarAnimationStepDuration animations:^{
			...
			self.searchFrame.layer.borderColor = [UIColor colorWithRed:104/255.0f green:186/255.0f blue:106/255.0f alpha:1.0].CGColor;
            
            PPRecipesViewController *delegate = (PPRecipesViewController *)self.delegate;
            delegate.placeholderLabel.alpha = 0.0;
...
//				self.searchFrame.layer.backgroundColor = [UIColor colorWithRed:255/255.0f green:255/255.0f blue:255/255.0f alpha:0.7].CGColor;
				...
				self.searchFrame.layer.backgroundColor = [UIColor colorWithRed:61/255.0f green:61/255.0f blue:61/255.0f alpha:1.0].CGColor;
                self.searchFrame.layer.borderColor = [UIColor colorWithRed:61/255.0f green:61/255.0f blue:61/255.0f alpha:1.0].CGColor;
...
- (void)hideSearchBar:(id)sender
{
	if (self.state == INSSearchBarStateSearchBarVisible || self.state == INSSearchBarStateSearchBarHasContent)
	{
		...
		[UIView animateWithDuration:kINSSearchBarAnimationStepDuration animations:^{
            ...
            PPRecipesViewController *delegate = (PPRecipesViewController *)self.delegate;
            delegate.placeholderLabel.alpha = 1.0;
