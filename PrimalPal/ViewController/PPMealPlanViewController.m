...
@interface PPMealPlanViewController () <INSSearchBarDelegate, UITableViewDataSource, UITableViewDelegate> {
    NSInteger selIdx;
}
...
@implementation PPMealPlanViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self performSegueWithIdentifier:@"ShowDetailFromMealPlan" sender:self];
}
